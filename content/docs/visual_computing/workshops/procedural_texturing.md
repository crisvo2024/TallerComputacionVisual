...
{{< p5-global-iframe id="prod_text" width="400" height="400" lib1="/showcase/scripts/p5.treegl.js">}}
    let pg;
    let truchetShader;

    function preload() {
    // shader adapted from here: https://thebookofshaders.com/09/
    truchetShader = readShader('/showcase/scripts/brickwall.frag', { matrices: Tree.NONE, varyings: Tree.NONE });
    }
